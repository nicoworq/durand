<?php
$inContacto = isset($footerContacto) && $footerContacto ? true : false;

$footerClass = $inContacto ? 'in-contacto' : ''
?>

<footer class="<?php echo $footerClass; ?>">

    <div class="<?php echo $footerClass; ?>" id="footer-contacto">
        <h1>Optimizamos sus productos al máximo<br/>
            con soluciones funcionales, estéticas<br/>
            e innovadoras.</h1>
        ...
        <?php if (!$inContacto) { ?>
            ...
            <a href="#" class="bt-sitio bt-oscuro">Contactenos</a>
        <?php } ?>
    ...
    <div id="footer-nav">
        <a href="#" id="footer-logo">
            <img src="img/logo-durand-footer.jpg" alt="Durand Design" />
        </a>
    ...
    <div id="footer-copyright">
        <span>© 2016 Durand Design</span>
        <a href="http://worq.com.ar" target="blank"> DESARROLLA WORQ | SOLUCIONES WEB</a>
    </div>
</footer>